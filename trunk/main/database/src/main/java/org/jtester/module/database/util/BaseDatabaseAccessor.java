...
import static org.jtester.module.database.support.DbSupportFactory.getDbSupports;
import static org.jtester.module.database.support.DbSupportFactory.getDefaultDbSupport;
...
abstract public class BaseDatabaseAccessor implements DatabaseAccessing {
	 ...
	 * {@link Properties}, {@link DataSource}.
	 * 
	 * @param configuration
	...
	/**
	 * Allows subclasses to perform some extra configuration using the given
	 * configuration.
	 * 
	 * @param configuration
	 *            The configuration, not null
