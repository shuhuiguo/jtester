...
public class DbSupportFactory {
	...
	public static DbSupport getDefaultDbSupport(Properties configuration, SQLHandler sqlHandler) {
		String defaultSchemaName = ConfigurationHelper.getStringList(PROPKEY_DATABASE_SCHEMA_NAMES, true).get(0);
	...
	public static DbSupport getDbSupport(Properties configuration, SQLHandler sqlHandler, String schemaName) {
		...
		// create new instance
		String databaseDialect = ConfigurationHelper.getString(configuration, PROPKEY_DATABASE_DIALECT);
		dbSupport = ConfigurationHelper.getInstanceOf(DbSupport.class, databaseDialect);
	...
	public static List<DbSupport> getDbSupports(Properties configuration, SQLHandler sqlHandler) {
		...
		List<String> schemaNames = ConfigurationHelper.getStringList(PROPKEY_DATABASE_SCHEMA_NAMES, true);
