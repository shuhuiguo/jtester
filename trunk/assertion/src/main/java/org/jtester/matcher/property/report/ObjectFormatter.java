...
import static org.jtester.matcher.property.reflection.HibernateUtil.getUnproxiedValue;
...
public class ObjectFormatter {
	...
	/**
	 * @return The interface that represents a dummy object. If the DummyObject
	 *         interface is not in the classpath, null is returned.
	 */
