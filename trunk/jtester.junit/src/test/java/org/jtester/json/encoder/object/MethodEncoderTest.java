...
public class MethodEncoderTest extends EncoderTest {
	...
	public void testEncodeSingleValue() throws Exception {
		...
		want.string(json)
				.isEqualTo(
						"{methodName:'demo2Para',declaredBy:'org.jtester.json.encoder.object.MethodJsonDemo',paraType:['java.lang.String','java.lang.Integer']}");
	}
	...
	public void testEncodeMethod() {
		...
		want.string(json)
				.isEqualTo(
						"{method:{methodName:'demo2Para',declaredBy:'org.jtester.json.encoder.object.MethodJsonDemo',paraType:['java.lang.String','java.lang.Integer']},name:'MethodJsonDemo'}");
	}
