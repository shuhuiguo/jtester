...
public class StoryXmlBuilder implements StoryQName {
	...
	public static String addScenario(Document document, StoryScenario scenario) {
		...
		String path = StoryXmlBuilder.addScenario(scenarios, scenario);
	...
	public static String addTemplateMethod(Document document, TemplateMethod template) {
		Element templatesNode = ((Element) document.selectSingleNode(StoryQName.xpathTemplates));
		if (templatesNode == null) {
			templatesNode = document.getRootElement().addElement(StoryQName.nodeTemplates);
		}
	...
	public static String addStoryScenario(Document document, String parentID, StoryScenario scenario) {
		if (!parentID.equals(StoryQName.xpathScenarios)) {
			return parentID;
		}
		Element scenariosNode = (Element) document.selectSingleNode(StoryQName.xpathScenarios);
		if (scenariosNode == null) {
			scenariosNode = document.getRootElement().addElement(StoryQName.nodeScenarios);
		}
	...
	public static String uptTemplateMethod(Document document, String xpathID, TemplateMethod method) {
		if (!xpathID.startsWith(StoryQName.xpathTemplatesMethod)) {
			return xpathID;
		}
	...
	public static String addTemplateMethod(Document document, String xpathID, TemplateMethod method) {
		if (!xpathID.equals(StoryQName.xpathTemplates)) {
			return xpathID;
		}
