...
public interface StoryQName {
	 ...
	 * story文件templates节点
	 */
	String nodeTemplates = "templates";
	/**
	 * story文件template方法节点
	 */
	String nodeTemplateMethod = "template";
	/**
	 * story文件场景列表节点
	 */
	 ...
	 */
	String xpathTemplates = "/story/templates";
	/**
	 * story文件templates方法节点xpath表达式
	 */
	String xpathTemplatesMethod = "/story/templates/template";
	/**
	 * 场景列表xpath表达式
	 */
	 ...
	 * story文件场景xpath
	 */
	String xpathScenario = "/story/scenarios/scenario";
	/**
	 * story文件场景方法xpath
	 */
	String xpathScenarioMethod = "/story/scenarios/scenario/method";
