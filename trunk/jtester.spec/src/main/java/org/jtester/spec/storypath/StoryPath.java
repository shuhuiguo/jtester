...
public abstract class StoryPath {
	 ...
	 * @return
	 */
	public abstract List<JSpecScenario> getStory(StoryFile storyFile, String encoding);
	 ...
	 * @return
	 */
	public static StoryPath factory(Class<? extends JSpec> claz, StoryFile storyFile) {
	...
	public static StoryPath titian(Class<? extends JSpec> claz) {
	...
	public static StoryPath classpath(Class<? extends JSpec> claz) {
