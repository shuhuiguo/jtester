...
public class ObjectTestedContext {
	private final static ObjectTestedContext context = new ObjectTestedContext();

	public final static ObjectTestedContext context() {
		return context;
	}
