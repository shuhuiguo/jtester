...
public class CoreModule {
	...
	private class CoreModuleListener extends TestListener {
		...
		public void setupClass(Object testObject) throws Exception {
			...
			TestContext.setContext(testObject, null);

			List<TestListener> listeners = ModulesManager.getTestListeners();
			for (TestListener listener : listeners) {
				listener.setupClass(testObject);
			}
		}
		...
		@Override
		public void afterMethodRunned(Object testObject, Method testMethod, Throwable throwable) throws Exception {
			TestContext.setContext(testObject, testMethod);
