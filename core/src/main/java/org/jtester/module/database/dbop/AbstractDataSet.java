...
public abstract class AbstractDataSet {
	 ...
	 * @return
	 */
	private static List<DataMap> parseMapList(int count, Map<String, ?> datas) {
	...
	private static Object getObjectFromDataGenerator(Map<String, Object> dataMap, Object dataGenerator, int index) {
