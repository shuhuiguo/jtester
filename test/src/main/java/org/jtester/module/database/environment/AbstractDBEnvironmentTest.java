...
public class AbstractDBEnvironmentTest extends JTester {
	...
	@DbFit(when = "data/AbstractDBEnvironmentTest/testCreateStatementWithBoundFixtureSymbols.when.wiki", then = "data/AbstractDBEnvironmentTest/testCreateStatementWithBoundFixtureSymbols.then.wiki")
	...
	@Test(groups = "oracle")
	@DbFit(when = "data/AbstractDBEnvironmentTest/oracle.when.wiki", then = "data/AbstractDBEnvironmentTest/oracle.then.wiki")
