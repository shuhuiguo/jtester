...
public class UpdaterBase implements Updater {
	...
	private void writeProperties(final OutputStream OutputStream) throws IOException {
		...
		Arrays.sort(keys);
		for (Enumeration<Object> enumeration = rootProperties.keys(); enumeration.hasMoreElements();) {
