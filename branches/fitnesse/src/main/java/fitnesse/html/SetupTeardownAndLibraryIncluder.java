...
public class SetupTeardownAndLibraryIncluder {
	...
	public static void includeSetupsTeardownsAndLibrariesBelowTheSuite(PageData pageData, WikiPage suitePage)
			throws Exception {
	...
	private class BelowSuiteLibraryFilter implements LibraryFilter {
		...
		public BelowSuiteLibraryFilter(WikiPage suitePage) throws Exception {
			minimumPathLength = suitePage.getPageCrawler().getFullPath(suitePage).addNameToEnd("ScenarioLibrary")
					.toString().length();
		}
