...
public class AttributeWikiPageFinder extends WikiPageFinder {
	...
	public AttributeWikiPageFinder(SearchObserver observer, List<PageType> requestedPageTypes,
			Map<String, Boolean> attributes, List<String> suites) {
		super(observer);
	...
	public AttributeWikiPageFinder(ExecuteSearchPropertiesResponder observer, List<PageType> pageTypes,
	...
	private boolean pageIsOfRequestedPageType(WikiPage page, List<PageType> requestedPageTypesEnum) throws Exception {
