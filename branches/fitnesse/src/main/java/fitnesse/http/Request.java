...
public class Request {
	...
	private Map<String, Object> parseHeaders(StreamReader reader) throws Exception {
	...
	private Object createUploadedFile(Map<String, Object> headers, StreamReader reader, String boundary)
			throws Exception {
