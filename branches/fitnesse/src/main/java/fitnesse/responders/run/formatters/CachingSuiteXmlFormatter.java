...
public class CachingSuiteXmlFormatter extends SuiteExecutionReportFormatter {
	...
	public TestExecutionReport getTestExecutionReport(SuiteExecutionReport.PageHistoryReference reference)
			throws Exception {
	...
	public long getTotalRunTimeInMillis() {
		...
		// so that it reads from the report directly as per
		// SuiteHistoryFormatter
