...
public class SuiteExecutionReport extends ExecutionReport {
	...
	public static class PageHistoryReference {
		...
		@Override
		public String toString() {
			return String.format("[%s, %s, %s, %s]", pageName, DateTimeUtil.formatDate(new Date(time)), testSummary,
					runTimeInMillis);
		}
		...
		public boolean equals(Object o) {
			...
			return StringUtil.stringsNullOrEqual(pageName, r.pageName) && time == r.time
					&& testSummary.equals(r.testSummary) && runTimeInMillis == r.runTimeInMillis;
		}
