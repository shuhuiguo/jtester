...
public class DeletePageResponder implements SecureResponder {
	...
	private String buildConfirmationHtml(final WikiPage root, final String qualifiedPageName,
			final FitNesseContext context) throws Exception {
	...
	private String makeMainContent(final WikiPage root, final String qualifiedPageName) throws Exception {
		...
		HtmlTag deletePageYesForm = HtmlUtil.makeFormTag("POST", qualifiedPageName
				+ "?responder=deletePage&confirmed=yes", "deletePageYesForm");
