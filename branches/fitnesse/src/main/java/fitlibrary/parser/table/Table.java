...
public class Table implements TableInterface {
	...
	public boolean equalsParse(Parse p1, Parse p2) {
		...
		if (p2 == null)
			return false;
		return p1.tag.equals(p2.tag) && equalStrings(p1.leader, p2.leader) && equalStrings(p1.body, p2.body)
				&& equalStrings(p1.trailer, p2.trailer) && equalsParse(p1.more, p2.more)
