...
/**
 * Task to run fit tests. This task runs fitnesse tests and publishes the
 * results.
 * <p/>
 * 
 * <pre>
...
public class ExecuteFitnesseTestsTask extends Task {
	...
	/**
	 * Name of the filter to be passed to TestRunner to specify a subset of
	 * tests to run.
	 * 
	 * @param suiteFilter
	 */
	...
	/**
	 * Name of the property which will store the test results. Only valid if
	 * failOnError attribute is set to false.
	 * 
	...
	/**
	 * Path to the folder that will contain the fitnesse results page after
	 * execution. Only valid if resultsHTMLPage or resultsXMLPage attributes are
	...
	/**
	 * If set, stores the fitnesse results in HTML format under the resultsdir
	 * folder with the given name. The file name must have a '.html' extension.
	 * 
	...
	/**
	 * If set, stores the fitnesse results in XML format under the resultsdir
	 * folder with the given name. The file name must have a '.xml' extension.
	 * 
	...
	/**
	 * Fully qualifies class name of the fitnesse testrunner class. Defaults to
	...
	/**
	 * Partial URL of the wiki page which is declared as a Suite. Ex:
	 * FrontPage.SmokeTest, FitNesse.SuiteAcceptanceTests, or
	 * FitNesse.AcceptanceTestsSuite. <b>MUST SET.</b>
	 * 
	 * @param suitePage
	 */
