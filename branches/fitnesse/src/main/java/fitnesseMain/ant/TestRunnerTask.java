...
/**
 * Task to run fit tests. This task starts the fit server, runs fitnesse tests
...
public class TestRunnerTask extends Task {
	...
	private void startFitNesse() {
		try {
			FitNesseMain.main(new String[] { "-p", String.valueOf(fitnessePort), "-d", wikiDirectoryRootPath, "-e",
					"0", "-o" });
		} catch (Exception e) {
