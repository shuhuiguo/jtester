...
public class WikiSourcePageTest {
	...
	public void getsVirtualChildren() throws Exception {
		...
		VirtualCouplingExtension extension = (VirtualCouplingExtension) virtualPage
	...
	public void getsUrlForProxyPage() throws Exception {
		...
		ProxyPage virtualPage = new ProxyPage("VirtualPage", root, "host", 9999,
				PathParser.parse("RealPage.VirtualPage"));
