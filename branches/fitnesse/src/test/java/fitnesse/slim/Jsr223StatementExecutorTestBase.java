...
public abstract class Jsr223StatementExecutorTestBase extends StatementExecutorTestBase {
	...
	public static class FixtureWithNamedSystemUnderTestJsr223 extends FixtureWithNamedSystemUnderTestBase {
	...
	public static class MyAnnotatedSystemUnderTestFixtureJsr223 extends MyAnnotatedSystemUnderTestFixture {
		private FixtureProxyJsr223 fixtureProxy;
	...
	public static class FixtureProxyJsr223 implements Echo, Speak, Delete, SystemUnderTestFixture {
		...
		public MySystemUnderTestBase getSystemUnderTest() {
			return new MySystemUnderTestJsr223(new FixtureProxyJsr223(callMethod("getSystemUnderTest")));
		}
	...
	protected Echo getVerifiedInstance() {
		FixtureProxyJsr223 myInstance = new FixtureProxyJsr223(statementExecutor.getInstance(INSTANCE_NAME));
	...
	protected EchoSupport createEchoLibrary() {
		...
		Object created = statementExecutor.create(instanceName, echoLibraryName(), new Object[] {});
		assertEquals("OK", created);
		return new EchoSupportJsr223(new FixtureProxyJsr223(statementExecutor.getInstance(instanceName)));
	}

	@Override
	protected FileSupport createFileSupportLibrary() {
		String instanceName = "library" + library++;
		Object created = statementExecutor.create(instanceName, fileSupportName(), new Object[] {});
		assertEquals("OK", created);
		return new FileSupportJsr223(new FixtureProxyJsr223(statementExecutor.getInstance(instanceName)));
	}
