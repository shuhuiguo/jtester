...
public class PropertiesAccessorImpl {
	/**
	...
	public static Object getProperty(final Object o, String prop) {
		...
		try {
			...
			MethodAccessorImpl accessor = new MethodAccessorImpl(o, method);
			return accessor.invoke(o, new Object[] {});
		} catch (Throwable e) {
			try {
				String method = StringHelper.camel("is", prop);
				MethodAccessorImpl accessor = new MethodAccessorImpl(o, method);
				Object b = accessor.invoke(o, new Object[] {});
				if (b instanceof Boolean) {
					return b;
				}
				throw new RuntimeException();
			} catch (Throwable e1) {
				Object o2 = FieldHelper.getFieldValue(o, prop);
				return o2;
			}
		}
	}
	...
	public static List<?> getArrayItemProperty(Object arr, String property) {
		...
		for (Object o : coll) {
			Object value = PropertiesAccessorImpl.getPropertyValue(o, property, false);
			values.add(value);
		}
		return values;
	}
	...
	public static Collection getArrayOrItemProperty(Object item, String property) {
		...
		if (ArrayHelper.isCollOrArray(item)) {
			values = PropertiesAccessorImpl.getArrayItemProperty(item, property);
		} else {
			Object o = PropertiesAccessorImpl.getProperty(item, property);
	...
	public static Object[][] getArrayItemProperties(Object arr, String[] properties) {
		...
		List values = new ArrayList();
		for (Object o : coll) {
			Object[] props = PropertiesAccessorImpl.getPropertyValue(o, properties, false);
			values.add(props);
		}
