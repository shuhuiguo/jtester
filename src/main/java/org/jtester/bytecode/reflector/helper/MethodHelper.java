...
public final class MethodHelper {
	...
	public static <T> T invoke(Object target, String method, Object... paras) {
		...
		MethodAccessor accessor = new MethodAccessorImpl(target, method, paraClazes);
	...
	public static <T> T invokeStatic(Class targetClass, String method, Object... paras) {
		...
		MethodAccessor accessor = new MethodAccessorImpl(targetClass, method, paraClazz.toArray(new Class[0]));
		return (T) accessor.invokeStatic(paras);
	}
	...
	public static <T> MethodAccessor<T> findMethodByArgCount(Class targetClazz, String methodName, int args) {
		...
		return new MethodAccessorImpl<T>(method);
	}
