...
import static org.jtester.module.utils.PropertyUtils.containsProperty;
import static org.jtester.module.utils.PropertyUtils.getString;
import static org.jtester.utility.ReflectionUtils.getClassWithName;
import static org.jtester.utility.ReflectionUtils.getEnumValue;
 ...
 * a method for retrieving all annotation property defaults (
 * {@link #getAnnotationPropertyDefaults(Class,java.util.Properties,Class[])} ).
 * The object that this method returns can later be used to get replace the
 * default placeholder of an annotation property for the default value as
 * configured in the unitils configuration.
 * 
 * @author Tim Ducheyne
 * @author Filip Neven
 */
public class ModuleUtils {
	 ...
	 * 
	 * @param moduleClass
	 *            The class of the module for which we want the default
	...
	public static Map<Class<? extends Annotation>, Map<String, String>> getAnnotationPropertyDefaults(
			Class<? extends Module> moduleClass, Properties configuration,
	 ...
	 *            The annotation class, not null
	 * @param name
	 *            The property suffix, not null
	 * @param configuration
	...
	public static <T extends Enum<?>> T getEnumValueReplaceDefault(Class<? extends Annotation> annotation,
			String annotationPropertyName, T enumValue,
	 ...
	 * @param allDefaultValues
	 *            the map with values to return in case of a default, not null
	 * @param defaultValueClass
	 *            the name of the default value
	 * @return the enumValue or the defaultValue in case of a default
	 */
	public static Class<?> getClassValueReplaceDefault(Class<? extends Annotation> annotation,
			String annotationPropertyName, Class<?> value,
			Map<Class<? extends Annotation>, Map<String, String>> allDefaultValues, Class<?> defaultValueClass) {
	 ...
	 *            the annotation property for which the value must be replaced,
	 *            not null
	 * @param valueAsString
	 *            the value to check, not null
	 * @param allDefaultValues
	 *            the map with values to return in case of a default, not null
	 * @param defaultValueName
	 *            the name of the default value, eg DEFAULT, not null @return
	...
	private static String getValueAsStringReplaceDefault(Class<? extends Annotation> annotation,
			String annotationProperty, String valueAsString,
			Map<Class<? extends Annotation>, Map<String, String>> allDefaultValues, String defaultValueName) {
