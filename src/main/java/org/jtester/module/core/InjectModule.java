...
public class InjectModule implements Module {
	...
	private void jtesterInject(Object testedObject) {
		...
		for (Field mockField : mockFields) {
			...
			Object injectedObject = FieldAccessor.getFieldValue(testedObject, mockField);
	...
	private static void injectedInto(Object testedObject, Object injectedObject, Class injectedClazz, String[] targets,
		...
		for (int index = 0; index < targets.length; index++) {
			...
			Object targetObject = PropertiesAccessor.getPropertyValue(testedObject, target, true);
			targetObject = PropertiesAccessor.getProxiedObject(targetObject);
