...
public class ConfigurationLoader {
	...
	private final static Logger log4j = Logger.getLogger(ConfigurationLoader.class);
	...
	private void loadCustomConfiguration(Properties properties) {
		...
		if (customProperties == null) {
			log4j.warn("No custom configuration file " + customConfigurationFileName + " found.");
		} else {
	...
	private void loadLocalConfiguration(Properties properties) {
		...
		if (localProperties == null) {
			log4j.info("No local configuration file " + localConfigurationFileName + " found.");
		} else {
