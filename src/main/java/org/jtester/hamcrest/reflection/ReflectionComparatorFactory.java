...
import static org.jtester.hamcrest.reflection.ReflectionComparatorMode.LENIENT_DATES;
...
import org.jtester.hamcrest.reflection.comparator.CollectionComparator;
import org.jtester.hamcrest.reflection.comparator.Comparator;
import org.jtester.hamcrest.reflection.comparator.HibernateProxyComparator;
import org.jtester.hamcrest.reflection.comparator.IgnoreDefaultsComparator;
import org.jtester.hamcrest.reflection.comparator.LenientDatesComparator;
import org.jtester.hamcrest.reflection.comparator.LenientNumberComparator;
import org.jtester.hamcrest.reflection.comparator.LenientOrderCollectionComparator;
import org.jtester.hamcrest.reflection.comparator.MapComparator;
import org.jtester.hamcrest.reflection.comparator.ObjectComparator;
import org.jtester.hamcrest.reflection.comparator.SimpleCasesComparator;
...
public class ReflectionComparatorFactory {
	...
	public static ReflectionComparator createRefectionComparator(ReflectionComparatorMode... modes) {
		List<Comparator> comparators = getComparatorChain(ArrayHelper.asSet(modes));
