...
public class TransactionManager {
	private final static Logger log4j = Logger.getLogger(TransactionManager.class);
	...
	public void endTransaction() {
		TransactionMode mode = TestContext.getTransactionMode();
	...
	private void commit() {
		...
		try {
			log4j.debug("commit transaction");
	...
	private void rollback() {
		...
		try {
			log4j.debug("Rolling back transaction");
