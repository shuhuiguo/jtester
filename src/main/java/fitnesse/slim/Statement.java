...
/**
 * Specifies the syntactic operations for a Slim statement. A Slim statement is
 * a list of strings. The first string is the operation name. Other strings are
 * arguments of the operation. This class knows that syntax, and knows how to
 * decompose it into StatementExecutor calls. This class DOES NOT know how to do
