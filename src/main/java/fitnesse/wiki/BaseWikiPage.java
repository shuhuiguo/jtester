...
public abstract class BaseWikiPage implements WikiPage {
	...
	protected WikiPage createInternalSymbolicPage(String linkPath, String linkName) throws Exception {
		...
		WikiPage start = (path.isRelativePath()) ? getParent() : this; // TODO
																		// -AcD-
																		// a
																		// better
																		// way?
	...
	private List<WikiPageAction> makeActions(String localPageName, String localOrRemotePageName,
			boolean newWindowIfRemote) throws Exception {
		...
		addActionForAttribute("Where Used", pageData, localOrRemotePageName, newWindowIfRemote, null, "whereUsed",
				actions);
	...
	private void addAction(String linkName, String pageName, boolean newWindowIfRemote, String shortcutKey,
			String query, List<WikiPageAction> actions) {
