...
public class MultipleTestsRunner implements TestSystemListener, Stoppable {
	...
	public MultipleTestsRunner(final List<WikiPage> testPagesToRun, final FitNesseContext fitNesseContext,
			final WikiPage page, final ResultsListener resultsListener) {
	...
	void allTestingComplete() throws Exception {
		...
		completionTimeMeasurement.stop(); // a non-trivial amount of time
											// elapses here
	}
	...
	private void executePagesInTestSystem(TestSystem.Descriptor descriptor, PagesByTestSystem pagesByTestSystem)
			throws Exception {
	...
	private void startTestSystemAndExecutePages(TestSystem.Descriptor descriptor, List<WikiPage> testSystemPages)
			throws Exception {
