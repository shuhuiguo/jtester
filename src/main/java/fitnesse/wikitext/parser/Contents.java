...
public class Contents extends SymbolType implements Rule, Translation {
	...
	public Maybe<Symbol> parse(Symbol current, Parser parser) {
		...
		current.evaluateVariables(new String[] { TOCWidget.HELP_TOC, TOCWidget.REGRACE_TOC, TOCWidget.PROPERTY_TOC,
				TOCWidget.FILTER_TOC, TOCWidget.MORE_SUFFIX_TOC }, parser.getVariableSource());
