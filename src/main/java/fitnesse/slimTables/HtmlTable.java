...
public class HtmlTable implements Table {
	...
	// This terrible algorithm is an example of either my hatred, or my
	// ignorance, of regular expressions.
	...
	class Cell {
		...
		public String getResult() {
			...
			} else if (result.equals("pass") || result.equals("fail") || result.equals("error")
		...
		public String getEscapedContent() {
			...
			// Some browsers need &nbsp; inside an empty table cell, so we
			// remove it here.
