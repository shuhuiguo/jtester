...
/**
 * Test support class for testing slim tables. Class provides the List of
 * {@link #instructions} created and the {@link #tableUnderTest} as protected
 * fields.
 * 
 * @param <T>
 *            The type of the table under test.
 */
public abstract class SlimTableTestSupport<T extends SlimTable> {
	...
	public T createSlimTable(String tableText) {
		try {
			Constructor<T> constructor = getParameterizedClass().getConstructor(Table.class, String.class,
					SlimTestContext.class);
