...
public class PageHistoryResponderTest {
	...
	private PageHistory.PassFailBar computePassFailBarFor(int right, int wrong, int ignores, int exceptions)
	...
	public void singlePassingResultShouldHaveTableandHeaderRow() throws Exception {
		...
		assertHasRegexp(
				"<table>.*<tr>.*<th>Time</th>.*<th>Pass</th>.*<th>Fail</th>.*<th colspan=\"50\">0..6</th>.*<tr",
				content);
	...
	private void addDummySuiteResult(File resultFile) throws Exception {
		...
		SuiteExecutionReport.PageHistoryReference r1 = new SuiteExecutionReport.PageHistoryReference(
				"SuitePage.TestPageOne", time, 9);
		SuiteExecutionReport.PageHistoryReference r2 = new SuiteExecutionReport.PageHistoryReference(
				"SuitePage.TestPageTwo", time, 11);
