...
public class ResourceHelperTest extends JTester {
	...
	public void findWikiFile_FilePath() throws Exception {
		File file = ResourceHelper.findWikiFile(null, "file:./src/main/java/org/jtester/utility/ResourceHelper.java");
		want.file(file).isExists();
	}

	@Test
	public void findWikiFile_ClassPath() throws Exception {
		InputStream stream = ResourceHelper.getResourceAsStream("org/jtester/utility/ResourceHelper.class");
		want.object(stream).notNull();
		File file = ResourceHelper.findWikiFile(null, "org/jtester/utility/ResourceHelper.class");
		want.file(file).isExists();
	}

	@Test
	public void findWikiFile_ClassPath2() throws Exception {
		File file = ResourceHelper.findWikiFile(ResourceHelper.class, "ResourceHelper.class");
		want.file(file).isExists();
	}
	...
	public void testGetResourceAsStream_file() throws FileNotFoundException {
		InputStream is = ResourceHelper
				.getResourceAsStream("file:src/test/resources/org/jtester/utility/executeFile.sql");
