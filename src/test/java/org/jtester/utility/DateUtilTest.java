...
public class DateUtilTest extends JTester {
	...
	public void testCurrDateTimeStr() {
		String dateStr = DateUtil.currDateTimeStr(getMockDate(), "yyyy-MM-dd HH:mm:ss");
		want.string(dateStr).isEqualTo("2010-02-12 19:58:55");
	}

	public void testCurrDateTimeStr_MockitExpectation() {
	...
	public void testCurrDateTimeStr_dynamicPartialMock() {
	...
	public void testParse() {
		...
		want.date(date).formatEqual("yyyy/MM/dd", "2010/10/20");
	}

	@Test
	public void testParse_包含毫秒() {
		Date date = DateUtil.parse("2010-10-20 18:20:36.231");
		want.date(date).formatEqual("yyyy/MM/dd hh:mm:ss.SSS", "2010/10/20 06:20:36.231");
	}
