...
import org.jtester.bytecode.reflector.impl.ClassAccessorTest.AccessPackageProtectedObject.AccessInner;
import org.jtester.bytecode.reflector.impl.ClassAccessor;
...
public class ClassAccessorTest extends JTester {
	...
	public void testCreateAccessorString() {
		ClassAccessor accessor = ClassAccessor.create("org.jtester.bytecode.reflector.model.PackagePrivateObject");
	...
	public void testForInnerStringDotNotation() {
		ClassAccessor innerAccessor = ClassAccessor.create("org.jtester.bytecode.reflector.model.PackagePrivateObject")
	...
	public void testCreateAccessorStringClassLoader() {
		ClassAccessor accessor = ClassAccessor.create("org.jtester.bytecode.reflector.model.PackagePrivateObject", getClass()
				.getClassLoader());
		String expectedName = "Alex";
		AccessPackageProtectedObject object = accessor.constructor(String.class).newProxy(
				AccessPackageProtectedObject.class, expectedName);
	...
	public void testConstructorClassOfQArrayNotExisting() {
		ClassAccessor.create("org.jtester.bytecode.reflector.model.PackagePrivateObject").constructor(Date.class);
	}
