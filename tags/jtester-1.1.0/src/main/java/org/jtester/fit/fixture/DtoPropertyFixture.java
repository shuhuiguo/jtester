...
public class DtoPropertyFixture extends SpringFixture {
	...
	protected void findMethod(Parse cell) {
		...
		try {
			if (argument == null) {
				...
				this.accessor = new MethodAccessorImpl<Object>(this, methodname, dtoClazz);
			}
			this.right(cell);
		} catch (Throwable e) {
			this.wrong(cell);
	...
	private Object instancePara(Parse cells) throws Exception {
		if (this.parsePropertyMethodName != null) {
			...
			try {
				MethodAccessor methodAccessor = new MethodAccessorImpl<Object>(this, parsePropertyMethodName,
						String.class);
	...
	protected class PropertyBinding {
		...
		public PropertyBinding(String property) throws Exception {
			this.fieldAccessor = new FieldAccessorImpl(dtoClazz, camel(property));
		...
		public void setValue(Object obj, String value) throws Exception {
			try {
				MethodAccessor methodAccessor = new MethodAccessorImpl<Object>(obj, parseMethodName, String.class);
