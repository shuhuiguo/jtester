...
public class DatabaseModule implements Module {
	private final static Logger log4j = Logger.getLogger(DatabaseModule.class);
	 ...
	 */
	public void init() {
		log4j.info("PlatformTransactionManager class init.");
	...
	protected class DatabaseTestListener extends TestListener {
		...
		public void setupMethod(Object testObject, Method testMethod) throws Exception {
			TestContext.setLocalTransactionManager();
		}
		...
		public void beforeMethodRunning(Object testObject, Method testMethod) throws Exception {
			...
			TransactionManager transaction = TestContext.getLocalTransactionManager();
...
//			// 强行结束已经存在的事务
//			boolean springAvailable = ClazzHelper.isClassAvailable(ClazzConst.PlatformTransactionManager);
//			if (springAvailable) {
//				TransactionManager.forceEndTransactional();
//			}
		}
		 ...
		 */
		@Override
		public void teardownMethod(Object testObject, Method testMethod) throws Exception {
			TestContext.removeLocalTransactionManager();
		}
