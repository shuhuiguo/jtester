...
public class BeanDefinitionRegister {
	private final static Logger log4j = Logger.getLogger(BeanDefinitionRegister.class);
	...
	public BeanDefinitionRegister(final DefaultListableBeanFactory factory, final AutoBeanInject autoBeanInject) {
	...
	public void ignoreNotFoundException(Throwable e) {
		if (this.autoBeanInject == null || this.autoBeanInject.ignoreNotFound()) {
			log4j.warn("ignore NotFound:" + (e == null ? "<null>" : e.getMessage()));
		} else {
