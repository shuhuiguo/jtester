...
public class FieldAccessorTest_FromReflectorUtil extends JTester {
	...
	public void testGetArrayItemProperty() {
		List<?> values = PropertiesAccessorImpl.getArrayItemProperty(
	...
	public void testGetArrayItemProperty_数组类型() {
		List<?> values = PropertiesAccessorImpl.getArrayItemProperty(new User[] { new User("ddd", "eeee"),
	...
	public void testGetArrayItemProperty_单值() {
		List<?> values = PropertiesAccessorImpl.getArrayItemProperty(new User("ddd", "eeee"), "first");
	...
	public void testGetArrayItemProperty_Map类型() {
		...
		List<?> values = PropertiesAccessorImpl.getArrayItemProperty(map, "first");
		want.collection(values).reflectionEq(new String[] { "ddd" });
	}
	...
	public void testGetArrayItemProperty_Map类型_集合() {
		...
		List<?> values = PropertiesAccessorImpl.getArrayItemProperty(list, "first");
		want.collection(values).reflectionEq(new String[] { "ddd", "ddd" });
	}

	@Test
	public void testGetArrayItemProperties() {
		Object[][] values = PropertiesAccessorImpl.getArrayItemProperties(
	...
	public void testGetArrayItemProperties_数组类型() {
		Object[][] values = PropertiesAccessorImpl.getArrayItemProperties(new User[] { new User("ddd", "eeee"),
	...
	public void testGetArrayItemProperties_单值() {
		Object[][] values = PropertiesAccessorImpl.getArrayItemProperties(new User("ddd", "eeee"), new String[] {
				"first", "last" });
	...
	public void testGetArrayItemProperties_Map类型() {
		...
		Object[][] values = PropertiesAccessorImpl.getArrayItemProperties(map, new String[] { "first", "last" });
		want.array(values).reflectionEq(new String[][] { { "ddd", "eeee" } });
	}
	...
	public void testGetArrayItemProperties_Map类型_集合() {
		...
		Object[][] values = PropertiesAccessorImpl.getArrayItemProperties(list, new String[] { "first", "last" });
		want.array(values).reflectionEq(new String[][] { { "ddd", "eeee" }, { "ddd", "eeee" } });
	}

	@Test(expectedExceptions = RuntimeException.class)
	public void testGetProperty() {
		PropertiesAccessorImpl.getProperty(null, "dd");
	}
	...
	public void testGetProperty_对象是Map() {
		...
		String value = (String) PropertiesAccessorImpl.getProperty(map, "wikiName");
		want.string(value).isEqualTo("eeee");

		value = (String) PropertiesAccessorImpl.getProperty(map, "kkkk");
	...
	public void testGetProperty_没有这个属性() {
		try {
			PropertiesAccessorImpl.getProperty(item, "dde");
			want.fail();
		} catch (Throwable e) {
	...
	public void testGetProperty_Get方法可以取到值() {
		String first = (String) PropertiesAccessorImpl.getProperty(item, "first");
	...
	public void testGetProperty_Get方法可以取到值_但方法在父类() {
		...
		String field = (String) PropertiesAccessorImpl.getProperty(item1, "myName");
		want.string(field).isEqualTo("first name,last name");
	}

	public void testGetProperty_Is方法可以取到值() {
		boolean isMan = (Boolean) PropertiesAccessorImpl.getProperty(item, "man");
		want.bool(isMan).is(true);
	}

	public void testGetProperty_只能通过直接取字段() {
		String field = (String) PropertiesAccessorImpl.getProperty(item, "noGetMethod");
		want.string(field).isEqualTo("no get method field");
	}

	public void testGetProperty_Get方法有逻辑() {
		String field = (String) PropertiesAccessorImpl.getProperty(item, "myName");
		want.string(field).isEqualTo("first name,last name");
	}

	public void testGetProperty_只能通过直接取字段_且字段在父类中() {
		SubForReflectUtil item1 = new SubForReflectUtil("first name", "last name");
		String field = (String) PropertiesAccessorImpl.getProperty(item1, "noGetMethod");
		want.string(field).isEqualTo("no get method field");
	}
	...
	public void testGetArrayOrItemProperty_单值对象_且属性值非集合() {
		Collection values = PropertiesAccessorImpl.getArrayOrItemProperty(new User("ddd", "ddd"), "first");
	...
	public void testGetArrayOrItemProperty_单值对象_且属性值为集合() {
		...
		Collection values = PropertiesAccessorImpl.getArrayOrItemProperty(user, "addresses");
