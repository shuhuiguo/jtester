...
public class InjectionModuleHelper {
	...
	private final static Logger log4j = Logger.getLogger(InjectionModuleHelper.class);
	...
	public static void injectIntoAnnotatedFields(Object objectToInject, Object target,
		...
		for (Field annotatedField : annotatedFields) {
			FieldAccessor.setFieldValue(target, annotatedField, objectToInject);
		}
	}
	...
	private static Object injectIntoFieldByType(Object objectToInject, Type objectToInjectType, Object target,
		...
		Set<Field> fieldsWithExactType = FieldAccessor.getFieldsOfType(targetClass, objectToInjectType);
		if (fieldsWithExactType.size() > 1) {
			...
			Set<Field> fieldsOfType = FieldAccessor.getFieldsAssignableFrom(targetClass, objectToInjectType);
		...
		Object oldValue = null;
		try {
			oldValue = FieldAccessor.getFieldValue(target, fieldToInjectTo);
		...
		FieldAccessor.setFieldValue(target, fieldToInjectTo, objectToInject);
		return oldValue;
	}
}
