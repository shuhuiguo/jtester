...
public class ProxyCallableStatementTest extends JTester {
	...
	public Object[][] returnProxyCallableStatementMethod() {
		return new Object[][] {// <br>
				...
				{ "getBigDecimal", new Class[] { int.class, int.class }, new Object[] { 1, 1 }, new BigDecimal("1.1") },
				...
				{ "registerOutParameter", new Class[] { int.class, int.class, String.class },
						new Object[] { 0, 0, "" }, null },
				// { "getInt", new Class[] { int.class }, new Object[] { 0 },
				// null }, /** <br> */
				// { "getURL", new Class[] { String.class }, new Object[] { ""
				// }, null }, /** <br> */
