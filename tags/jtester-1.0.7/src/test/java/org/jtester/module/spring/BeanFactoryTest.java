...
public class BeanFactoryTest extends JTester {
	...
	public void testXmlBeanDefinitionReader() {
		Resource beanRes = new ClassPathResource("org/jtester/fortest/spring/beans.xml");
		Resource dbRes = new ClassPathResource("org/jtester/fortest/spring/data-source.xml");
	...
	public void testClassPathContext_autoTracer() {
		...
		reader.loadBeanDefinitions(new Resource[] { beanRes, dbRes });
		BeanDefinitionRegistry registry = reader.getRegistry();
		TracerModuleHelper.addTracerBeanDefinition(registry);
	...
	public void testClassPathContext() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext(new String[] {
				"org/jtester/fortest/spring/data-source.xml", "org/jtester/fortest/spring/beans.xml",
