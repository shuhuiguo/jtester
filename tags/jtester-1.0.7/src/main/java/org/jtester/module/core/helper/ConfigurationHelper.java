...
public class ConfigurationHelper implements ConfigurationConst {
	private final static Logger log4j = Logger.getLogger(ConfigurationHelper.class);
	...
	public static <T> T getInstanceOf(Class<? extends T> type, String... implementationDiscriminatorValues) {
		...
		log4j.debug("Creating instance of " + type + ". Implementation class " + implClassName);
