 ...
 */
package org.jtester.hamcrest.reflection.comparator;
...
public class CollectionComparator implements Comparator {
	...
	public Difference compare(Object left, Object right, boolean onlyFirstDifference,
		...
		Collection<?> left_coll = ArrayHelper.convertToCollection(left);
		List<Object> leftList = new ArrayList<Object>(left_coll);
		Collection<?> right_coll = ArrayHelper.convertToCollection(right);
		List<Object> rightList = new ArrayList<Object>(right_coll);
