...
public class PropertyUtils {
	 ...
	 * property is found or the value is empty, an exception will be raised.
	 * 
	 * @param propertyName
	 *            The name, not null
	 * @param properties
	...
	/**
	 * Gets the boolean value for the property with the given name. If no such
	 * property is found or the value is empty, an exception will be raised.
	 * 
	 * @param propertyName
	 *            The name, not null
	...
	/**
	 * Gets the long value for the property with the given name. If no such
	 * property is found, the value is empty or cannot be converted to a long,
	...
	public static long getLong(String propertyName, Properties properties) {
		...
		try {
			...
			throw new JTesterException("Value " + value + " for property " + propertyName + " is not a number.");
		}
	}
	 ...
	 * Gets the long value for the property with the given name. If no such
	 * property is found or the value is empty, the given default value is
	 * returned. If the value cannot be converted to a long, an exception will
	 * be raised.
	 * 
	 * @param propertyName
	 *            The name, not null
	...
	/**
	 * Gets the int value for the property with the given name. If no such
	 * property is found, the value is empty or cannot be converted to a long,
	 * an exception will be raised.
	 * 
	 * @param propertyName
	...
	/**
	 * Checks whether the property with the given name exists in the System or
	...
	/**
	 * Gets an instance of the type specified by the property with the given
	 * name. If no such property is found, the value is empty, the given default
	 * value is returned. If the instance cannot be created an exception will be
	 * raised.
	 * 
	 * @param propertyName
	 *            The name, not null
