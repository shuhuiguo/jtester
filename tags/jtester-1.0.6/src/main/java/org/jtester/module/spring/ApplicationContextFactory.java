...
public interface ApplicationContextFactory {
	 ...
	 */
	AbstractApplicationContext createApplicationContext(Object testedObject, List<String> locations,
			boolean ignoreNoSuchBeanDefinitionException);
