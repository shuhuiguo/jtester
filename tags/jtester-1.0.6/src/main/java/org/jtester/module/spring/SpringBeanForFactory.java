...
public class SpringBeanForFactory implements FactoryBean, BeanFactoryAware {
	private static Logger log = Logger.getLogger(SpringBeanForFactory.class);
	...
	public Object getObject() throws Exception {
		...
		Object o = FieldProxy.proxy(testedObject, fieldName);
		return o;
	}
	...
	public Class getObjectType() {
		if (type == null && this.beanFactory != null) {
			...
			Field field = FieldAccessor.getField(testedObject.getClass(), this.fieldName);
	...
	public static void registerSpringBeanForField(final DefaultListableBeanFactory beanFactory, Class<?> testedClazz) {
		Set<Field> beanFields = getFieldsAnnotatedWith(testedClazz, SpringBeanFor.class);

		for (Field beanField : beanFields) {
			SpringBeanFor beanFor = beanField.getAnnotation(SpringBeanFor.class);
	...
	private static void registerProxyBeanDefinition(final DefaultListableBeanFactory beanFactory,
		...
		beanDefinition.setBeanClassName(SpringBeanForFactory.class.getName());
