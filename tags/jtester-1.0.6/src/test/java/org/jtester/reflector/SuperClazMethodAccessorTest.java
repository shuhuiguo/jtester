...
import org.jtester.reflector.service.MyServiceImpl.MyTestException;
...
public class SuperClazMethodAccessorTest extends JTester {
	...
	public static interface ExMyService extends MyService {
		...
		public String privateInvoked(String in);
	...
	public static class ExMyServciceImpl extends MyServiceImpl implements ExMyService {
		...
		public String privateInvoked(String in) {
			MethodAccessor<String> method = new MethodAccessor<String>(this, MyServiceImpl.class, "privateInvoked",
					String.class);
