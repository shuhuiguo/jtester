...
public class WantStyleAssertion {
	...
	private final static JTesterFitnesse dbfit = new JTesterFitnesse();

	public ICollectionAssert database(String query) {
		dbfit.useDefaultDataSource();
		List result = (List) dbfit.queryList(query, HashMap.class);
		ICollectionAssert assertion = new CollectionAssert(result);
		return assertion;
	}

	public IMapAssert database(String dataSource, String query) {
		dbfit.useDefaultDataSource();
		return null;
	}
}
