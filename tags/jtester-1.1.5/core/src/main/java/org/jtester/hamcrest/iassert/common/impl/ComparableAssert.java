...
public class ComparableAssert<T, E extends IAssert> extends AllAssert<T, E> implements IComparableAssert<T, E> {
	...
	public E lt(T max) {
		return this.isLessThan(max);
	}

	public E le(T max) {
		return this.isLessEqual(max);
	}

	public E gt(T min) {
		return this.isGreaterThan(min);
	}

	public E ge(T min) {
		return this.isGreaterEqual(min);
	}
