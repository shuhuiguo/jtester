...
public class PropertiesEqualMatcherTest extends JTester {
	...
	public Iterator matchData() {
		return new DataIterator() {
			{
				put(newUser("abc"), "abc", "name", null, true);
				put(newUser("abc"), null, "name", null, false);
				put(newUser("abc"), null, "name", new EqMode[] { EqMode.IGNORE_DEFAULTS }, true);
				put(newUser("abc"), newUser("abc"), "name", null, true);
				put(newUser("abc"), toList(123, "abc"), "id,name", null, true);
				put(newUser("abc"), toList("abc", 123), "id,name", null, false);
				put(newUser("abc"), toList("abc", 123), "id,name", new EqMode[] { EqMode.IGNORE_ORDER }, true);
				put(newUser("abc"), newMap("abc"), "id,name", null, true);
				put(toList(newUser("abc"), newUser("darui.wu")), toArray("abc", "darui.wu"), "name", null, true);
				put(toArray(newMap("abc"), newUser("darui.wu")), toList(newUser("abc"), newMap("darui.wu")), "name",
						null, true);
				put(toArray(newMap("abc"), newUser("darui.wu")), toList(newUser("abc"), null), "name",
						new EqMode[] { EqMode.IGNORE_DEFAULTS }, true);
				put(toArray(newMap("abc"), newUser("darui.wu")), toList(newUser("darui.wu"), newMap("abc")), "name",
						new EqMode[] { EqMode.IGNORE_ORDER }, true);
				put(toArray(newMap("abc"), newUser("darui.wu")), toList(newUser("abc"), newMap("darui.wu")),
						"id,name", null, true);
				put(toArray(newMap("abc"), newUser("darui.wu")), toList(newUser("abc"), newMap(null)), "id,name",
						new EqMode[] { EqMode.IGNORE_DEFAULTS }, true);
				put(toArray(newMap("abc"), newUser("darui.wu")), toList(newMap(null), newUser("abc")), "id,name",
