...
public class JTesterFitnesse {
	 ...
	 * @throws SQLException
	 */
	public void execute(String sql, String... sqls) throws SQLException {
	 ...
	 */
	public void executeSQLFile(String sqlFile) throws SQLException, FileNotFoundException {
		SqlRunner.executeFromFile(sqlFile);
	}
	 ...
	 * @throws FileNotFoundException
	 */
	public void executeSQLFile(Map<String, ?> symbols, String sqlFile) throws SQLException, FileNotFoundException {
		SqlRunner.executeFromFile(symbols, sqlFile);
	}
	 ...
	 * @throws SQLException
	 */
	public <T> T query(String sql, Class<T> claz) throws SQLException {
		T result = SqlRunner.query(sql, claz);
		return result;
	}
	 ...
	 * @throws SQLException
	 */
	public <T> List<T> queryList(String sql, Class<T> clazz) throws SQLException {
		List<T> list = SqlRunner.queryList(sql, clazz);
		return list;
	}
}
